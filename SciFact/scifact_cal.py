...
parser = argparse.ArgumentParser(description="Set alpha values for model and csv naming.")
...
if args.method == "merge":
    ...
    csv_name = f"./score/scifact_score_merge_linear_{args.alpha_lower}_{args.alpha_upper}.csv"
