...
if args.method == "merge":
    ...
    csv_name = f"./score/miracl_score_merge_linear_{args.alpha_lower}_{args.alpha_upper}.csv"
...
for i in range(num_batches):
    ...
    q_list = [get_detailed_instruct(task, row["text"]) for _, row in batch_queries.iterrows()]
